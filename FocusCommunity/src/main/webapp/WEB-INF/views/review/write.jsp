...
<body>
<form id="frm" name="frm" action="/review/write" method="post">
	<!--**********************************
    	Nav header start
	***********************************-->
						...
						<div class="card-body">
							...
							<div class="row">
								...
								<div class="form-group note-editable">
									<textarea id="content" class="summernote" name="ccont" rows="25" style="width:100%" placeholder="내용을 입력해주세요."></textarea>
								</div>
							</div>
							<br><br><br>

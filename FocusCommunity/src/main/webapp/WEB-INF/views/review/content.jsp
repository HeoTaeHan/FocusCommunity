									...
									<div class="right-box-padding">
										<div class="read-content">
											<div class="media pt-3">
												...
												<input type="hidden" name="filename" value="${ cusbodVO.filetype}">
	...
	<script>
		...
		$('#btnRemove').on('click', function(){
			...
			swal({ title: "게시글삭제", 
				...
				if (result.value == true) {
	  				location.href = '/review/remove?csnum=${ cusbodVO.csnum }&ctype=${cusbodVO.ctype}&pageNum=${ pageNum }&keyword=${keyword}&type=${type}&uuid=${cusbodVO.filetype}';
				}
			});
		});
	</script>
